    ...
    devServer: {
        ...
        historyApiFallback: {
            rewrites: [
              ...
              { from: /^\/blog\.html/, to: '/views/blog.html' },
              { from: /^\/entrada\.html/, to: '/views/entrada.html' },
              { from: /^\/nosotros\.html/, to: '/views/nosotros.html' },
              { from: /^\/producto\.html/, to: '/views/producto.html' },
              { from: /^\/tienda\.html/, to: '/views/tienda.html' },
            ]
          }
    }
